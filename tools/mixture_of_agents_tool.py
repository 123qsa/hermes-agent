...
- Reference Models: moonshotai/kimi-for-coding, gemini-3-pro-preview, gpt-5.4-pro, deepseek-v3.2
- Aggregator Model: moonshotai/kimi-for-coding (highest capability for synthesis)
...
AGGREGATOR_MODEL = "moonshotai/kimi-for-coding"
